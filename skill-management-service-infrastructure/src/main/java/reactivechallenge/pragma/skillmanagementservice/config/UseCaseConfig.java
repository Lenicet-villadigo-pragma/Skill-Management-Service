...
import reactivechallenge.pragma.skillmanagementservice.usecase.DeleteSkillUseCase;
...
public class UseCaseConfig {
    ...
    @Bean
    public IDeleteSkillServicePort creatorEraserSkillServicePort(ISkillRepositoryPort skillRepositoryPort
    , ITechnologyServicePort technologyServicePort) {
        return new DeleteSkillUseCase(skillRepositoryPort, technologyServicePort);
    }
}
